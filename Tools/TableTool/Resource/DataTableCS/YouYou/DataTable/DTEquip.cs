...
public struct DTEquip : IFlatbufferObject
{
  ...
  public static Offset<YouYou.DataTable.DTEquip> CreateDTEquip(FlatBufferBuilder builder,
      int Id = 0,
  ...
  public static Offset<YouYou.DataTable.DTEquip> EndDTEquip(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTEquip>(o);
  }
};
