...
public class CameraCtrl : MonoBehaviour, IUpdateComponent
{
    /// <summary>
    /// 控制摄像机上下
    /// </summary>
    [SerializeField] private Transform m_CameraUpAndDown;

    /// <summary>
    /// 摄像机缩放父物体
    /// </summary>
    [SerializeField] private Transform m_CameraZoomContainer;
    ...
    [Header("左右旋转速度")] [SerializeField] private int m_RotateSpeed = 80;
    ...
    /// 结束拖拽帧距离
    /// </summary>
    [HideInInspector] public float OnDragEndDistance;

    [Header("上下速度")] [SerializeField] private int m_UpAndDownSpeed = 60;

    [Header("上下滑动边界限制")] [SerializeField] private Vector2 m_UpAndDownLimit;

    [Header("缩放速度")] [SerializeField] private int m_ZoomSpeed = 10;

    [Header("缩放边界限制")] [SerializeField] private Vector2 m_ZoomLimit;
    ...
    public void Init()
    {
        m_CameraUpAndDown.transform.localEulerAngles = new Vector3(0, 0,
            Mathf.Clamp(m_CameraUpAndDown.transform.localEulerAngles.z, 35f, 80f));
    }
    ...
    public void SetCameraUpAndDown(int type)
    {
        ...
        m_CameraUpAndDown.transform.localEulerAngles = new Vector3(0, 0,
            Mathf.Clamp(m_CameraUpAndDown.transform.localEulerAngles.z, m_UpAndDownLimit.x, m_UpAndDownLimit.y));
    }
    ...
    public void SetCameraZoom(int type)
    {
        ...
        m_CameraContainer.localPosition = new Vector3(0, 0,
            Mathf.Clamp(m_CameraContainer.localPosition.z, m_ZoomLimit.x, m_ZoomLimit.y));
    }
    ...
    public void OnUpdate()
    {
        if (!IsOnDrag && m_AutoRotateSpeed > 0)
        {
            ...
            {
                m_AutoRotateSpeed -=
                    Mathf.Clamp((100 - Mathf.Clamp(changeDistance, 0, 99)) * Time.deltaTime * 10, 5, 15);
                SetCameraRotateAuto();
            }
        }
    }
