...
namespace YouYou
{
    ...
    public class DownloadMulitRoutine : IDisposable
    {
        ...
        public void BeginDownloadMulit(LinkedList<string> lstUrl,
            BaseAction<int, int, ulong, ulong> onDownloadMulitUpdate = null, BaseAction<DownloadMulitRoutine> onDownloadMulitComplete = null)
        {
        ...
        private void OnDownloadMulitUpdate(string url, ulong currDownloadedSize, float progress)
        {
            ...
            m_OnDownloadMulitUpdate?.Invoke(m_DownloadMulitCurrCount, m_DownloadMulitNeedCount, m_DownloadMulitCurrSize,
