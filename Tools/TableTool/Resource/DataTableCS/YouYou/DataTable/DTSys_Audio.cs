...
public struct DTSys_Audio : IFlatbufferObject
{
  ...
  public static Offset<YouYou.DataTable.DTSys_Audio> CreateDTSys_Audio(FlatBufferBuilder builder,
      int Id = 0,
  ...
  public static Offset<YouYou.DataTable.DTSys_Audio> EndDTSys_Audio(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTSys_Audio>(o);
  }
};
