...
public struct DTSys_LocalizationList : IFlatbufferObject
{
  ...
  public YouYou.DataTable.DTSys_Localization? DTSysLocalizations(int j) { int o = __p.__offset(4); return o != 0 ? (YouYou.DataTable.DTSys_Localization?)(new YouYou.DataTable.DTSys_Localization()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int DTSysLocalizationsLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<YouYou.DataTable.DTSys_LocalizationList> CreateDTSys_LocalizationList(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateDTSysLocalizationsVector(FlatBufferBuilder builder, Offset<YouYou.DataTable.DTSys_Localization>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateDTSysLocalizationsVectorBlock(FlatBufferBuilder builder, Offset<YouYou.DataTable.DTSys_Localization>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartDTSysLocalizationsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<YouYou.DataTable.DTSys_LocalizationList> EndDTSys_LocalizationList(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTSys_LocalizationList>(o);
  }
};
