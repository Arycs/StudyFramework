...
namespace YouYou
{
    ...
    public class DownloadRoutine
    {
        ...
        public void BeginDownload(string url, AssetBundleInfoEntity assetBundleInfo,
            BaseAction<string, ulong, float> onUpdate = null, BaseAction<string, DownloadRoutine> onComplete = null)
        {
            m_CurrFileUrl = url;
