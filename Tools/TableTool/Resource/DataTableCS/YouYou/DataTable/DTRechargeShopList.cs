...
public struct DTRechargeShopList : IFlatbufferObject
{
  ...
  public YouYou.DataTable.DTRechargeShop? DTRechargeShops(int j) { int o = __p.__offset(4); return o != 0 ? (YouYou.DataTable.DTRechargeShop?)(new YouYou.DataTable.DTRechargeShop()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int DTRechargeShopsLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<YouYou.DataTable.DTRechargeShopList> CreateDTRechargeShopList(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateDTRechargeShopsVector(FlatBufferBuilder builder, Offset<YouYou.DataTable.DTRechargeShop>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateDTRechargeShopsVectorBlock(FlatBufferBuilder builder, Offset<YouYou.DataTable.DTRechargeShop>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartDTRechargeShopsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<YouYou.DataTable.DTRechargeShopList> EndDTRechargeShopList(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTRechargeShopList>(o);
  }
};
