...
public struct DTWorldMap : IFlatbufferObject
{
  ...
  public static Offset<YouYou.DataTable.DTWorldMap> CreateDTWorldMap(FlatBufferBuilder builder,
      int Id = 0,
  ...
  public static Offset<YouYou.DataTable.DTWorldMap> EndDTWorldMap(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTWorldMap>(o);
  }
};
