...
public class AssetBundleWindow : EditorWindow
{
    ...
    private void OnChangeLuaScriptCallBack()
    {
        ...
        string dest = Application.dataPath + "/../AssetBundles/" + arrBuildTarget[buildTargetIndex] +
                      "/Download/xLuaLogic";
    ...
    private void OnCreateVersionFileCallBack()
    {
        ...
        for (int i = 0; i < arrFiles.Length; i++)
        {
            ...
            //相对路径
            string name = fullName.Substring(fullName.IndexOf(arrBuildTarget[buildTargetIndex]) +
    ...
    private void OnCreateDependenciesFile()
    {
        ...
        //生成一个Json文件
        string targetPath = Application.dataPath + "/../AssetBundles/" + dal.GetVersion() + "/" +
                            arrBuildTarget[buildTargetIndex];
