...
public struct DTSys_StorySound : IFlatbufferObject
{
  ...
  public static Offset<YouYou.DataTable.DTSys_StorySound> CreateDTSys_StorySound(FlatBufferBuilder builder,
      int Id = 0,
  ...
  public static Offset<YouYou.DataTable.DTSys_StorySound> EndDTSys_StorySound(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTSys_StorySound>(o);
  }
};
