...
/// DTGameLevel数据管理
/// </summary>
public partial class DTGameLevelDBModel : DataTableDBModelBase<DTGameLevelDBModel, DTGameLevelEntity>
{
    /// <summary>
    /// 文件名称
    /// </summary>
    public override string DataTableName { get { return "DTGameLevel"; } }
    ...
    protected override void LoadList(MMO_MemoryStream ms)
    {
        ...
        {
            DTGameLevelEntity entity = new DTGameLevelEntity();
