...
public struct DTRoleAnimCategory : IFlatbufferObject
{
  ...
  public int Attack(int j) { int o = __p.__offset(12); return o != 0 ? __p.bb.GetInt(__p.__vector(o) + j * 4) : (int)0; }
  public int AttackLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<int> GetAttackBytes() { return __p.__vector_as_span<int>(12, 4); }
#else
  public ArraySegment<byte>? GetAttackBytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public int[] GetAttackArray() { return __p.__vector_as_array<int>(12); }

  public static Offset<YouYou.DataTable.DTRoleAnimCategory> CreateDTRoleAnimCategory(FlatBufferBuilder builder,
      int Id = 0,
  ...
  public static void StartDTRoleAnimCategory(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static void AddAttack(FlatBufferBuilder builder, VectorOffset AttackOffset) { builder.AddOffset(4, AttackOffset.Value, 0); }
  ...
  public static Offset<YouYou.DataTable.DTRoleAnimCategory> EndDTRoleAnimCategory(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTRoleAnimCategory>(o);
  }
};
