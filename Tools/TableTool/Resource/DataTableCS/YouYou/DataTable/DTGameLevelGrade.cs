...
public struct DTGameLevelGrade : IFlatbufferObject
{
  ...
  public static Offset<YouYou.DataTable.DTGameLevelGrade> CreateDTGameLevelGrade(FlatBufferBuilder builder,
      int Id = 0,
      int GameLevelId = 0,
      int Grade = 0,
  ...
  public static Offset<YouYou.DataTable.DTGameLevelGrade> EndDTGameLevelGrade(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTGameLevelGrade>(o);
  }
};
