...
public struct DTGameLevelMonster : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_1_12_0(); }
  public static DTGameLevelMonster GetRootAsDTGameLevelMonster(ByteBuffer _bb) { return GetRootAsDTGameLevelMonster(_bb, new DTGameLevelMonster()); }
  public static DTGameLevelMonster GetRootAsDTGameLevelMonster(ByteBuffer _bb, DTGameLevelMonster obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public DTGameLevelMonster __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
...
#if ENABLE_SPAN_T
  public Span<byte> GetDropEquipBytes() { return __p.__vector_as_span<byte>(20, 1); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetDropItemBytes() { return __p.__vector_as_span<byte>(22, 1); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetDropMaterialBytes() { return __p.__vector_as_span<byte>(24, 1); }
#else
  ...
  public static Offset<YouYou.DataTable.DTGameLevelMonster> CreateDTGameLevelMonster(FlatBufferBuilder builder,
      int Id = 0,
      int GameLevelId = 0,
      int Grade = 0,
      int RegionId = 0,
    ...
    DTGameLevelMonster.AddDropMaterial(builder, DropMaterialOffset);
    DTGameLevelMonster.AddDropItem(builder, DropItemOffset);
    DTGameLevelMonster.AddDropEquip(builder, DropEquipOffset);
    DTGameLevelMonster.AddGold(builder, Gold);
    DTGameLevelMonster.AddExp(builder, Exp);
    DTGameLevelMonster.AddSpriteCount(builder, SpriteCount);
    DTGameLevelMonster.AddSpriteId(builder, SpriteId);
    DTGameLevelMonster.AddRegionId(builder, RegionId);
    DTGameLevelMonster.AddGrade(builder, Grade);
    DTGameLevelMonster.AddGameLevelId(builder, GameLevelId);
    DTGameLevelMonster.AddId(builder, Id);
    return DTGameLevelMonster.EndDTGameLevelMonster(builder);
  }

  public static void StartDTGameLevelMonster(FlatBufferBuilder builder) { builder.StartTable(11); }
  ...
  public static Offset<YouYou.DataTable.DTGameLevelMonster> EndDTGameLevelMonster(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTGameLevelMonster>(o);
  }
};
