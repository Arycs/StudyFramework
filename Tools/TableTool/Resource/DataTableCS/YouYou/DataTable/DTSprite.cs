...
public struct DTSprite : IFlatbufferObject
{
...
#if ENABLE_SPAN_T
  public Span<byte> GetTextureNameBytes() { return __p.__vector_as_span<byte>(16, 1); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetHeadPicBytes() { return __p.__vector_as_span<byte>(18, 1); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetUsedPhyAttackBytes() { return __p.__vector_as_span<byte>(44, 1); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetUsedSkillListBytes() { return __p.__vector_as_span<byte>(46, 1); }
#else
  ...
  public static Offset<YouYou.DataTable.DTSprite> CreateDTSprite(FlatBufferBuilder builder,
      int Id = 0,
      int SpriteType = 0,
    ...
    DTSprite.AddRewardExp(builder, RewardExp);
    DTSprite.AddDelaySecAttack(builder, DelaySec_Attack);
    DTSprite.AddPhysicalAttackRate(builder, PhysicalAttackRate);
    DTSprite.AddAttackInterval(builder, Attack_Interval);
    DTSprite.AddRangeView(builder, Range_View);
    DTSprite.AddArmorHPPercentage(builder, Armor_HP_Percentage);
    DTSprite.AddCanArmor(builder, CanArmor);
    DTSprite.AddUsedSkillList(builder, UsedSkillListOffset);
    DTSprite.AddUsedPhyAttack(builder, UsedPhyAttackOffset);
    DTSprite.AddBloodBarLayerCount(builder, BloodBarLayerCount);
    DTSprite.AddShowBloodBar(builder, ShowBloodBar);
    DTSprite.AddFighting(builder, Fighting);
    DTSprite.AddRes(builder, Res);
    DTSprite.AddCri(builder, Cri);
    DTSprite.AddDodge(builder, Dodge);
    DTSprite.AddHit(builder, Hit);
    DTSprite.AddDefense(builder, Defense);
    DTSprite.AddAttack(builder, Attack);
    DTSprite.AddMP(builder, MP);
    DTSprite.AddHP(builder, HP);
    DTSprite.AddMoveSpeed(builder, MoveSpeed);
    DTSprite.AddHeadPic(builder, HeadPicOffset);
    DTSprite.AddTextureName(builder, TextureNameOffset);
    DTSprite.AddPrefabName(builder, PrefabNameOffset);
  ...
  public static void StartDTSprite(FlatBufferBuilder builder) { builder.StartTable(29); }
  ...
  public static Offset<YouYou.DataTable.DTSprite> EndDTSprite(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTSprite>(o);
  }
};
