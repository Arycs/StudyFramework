...
public struct DTSys_Scene : IFlatbufferObject
{
  ...
  public static Offset<YouYou.DataTable.DTSys_Scene> CreateDTSys_Scene(FlatBufferBuilder builder,
      int Id = 0,
  ...
  public static Offset<YouYou.DataTable.DTSys_Scene> EndDTSys_Scene(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTSys_Scene>(o);
  }
};
