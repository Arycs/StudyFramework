    ...
    public class YouYouSocketEventWrap 
    {
        ...
        static int _s_set_dic(RealStatePtr L)
        {
		    try {
                ...
                YouYou.SocketEvent gen_to_be_invoked = (YouYou.SocketEvent)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.dic = (System.Collections.Generic.Dictionary<ushort, System.Collections.Generic.LinkedList<YouYou.SocketEvent.OnActionHandler>>)translator.GetObject(L, 2, typeof(System.Collections.Generic.Dictionary<ushort, System.Collections.Generic.LinkedList<YouYou.SocketEvent.OnActionHandler>>));
