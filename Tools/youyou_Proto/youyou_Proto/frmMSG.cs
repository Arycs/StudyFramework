...
namespace ReadExcel
{
    public partial class frmMSG : Form
    {
        ...
        private void CreateServerProto(MyProto proto, bool isSave = false)
        {
            ...
            sbr.AppendFormat("{{\r\n");
            sbr.AppendFormat("    public ushort ProtoCode => {0};\r\n", proto.ProtoCode);
            sbr.AppendFormat("    public string ProtoEnName => \"{0}\";\r\n", proto.ProtoEnName);
            sbr.AppendFormat("    public ProtoCategory Category => ProtoCategory.{0};\r\n", proto.ProtoCategory);
            ...
            sbr.AppendFormat("            ms.WriteByte((byte)Category);\r\n");
            sbr.AppendFormat("        }}\r\n");
            sbr.Append("\r\n");
        ...
        {
            if (!proto.ProtoCategory.Equals("WorldServer2Client") && !proto.ProtoCategory.Equals("GameServer2Client")
                && !proto.ProtoCategory.Equals("GatewayServer2Client")
                ) return;
        ...
        private void CreateSocketProtoListener()
        {
            ...
            foreach (var menu in DataMgr.Instance.MenuList)
            {
                foreach (var proto in menu.ProtoList)
                {
                    if (proto.IsCSharp && (proto.ProtoCategory.Equals("WorldServer2Client") || proto.ProtoCategory.Equals("GameServer2Client")
                        || proto.ProtoCategory.Equals("GatewayServer2Client")
                        ))
                    {
            ...
            foreach (var menu in DataMgr.Instance.MenuList)
            {
                foreach (var proto in menu.ProtoList)
                {
                    if (proto.IsLua && (proto.ProtoCategory.Equals("WorldServer2Client") || proto.ProtoCategory.Equals("GameServer2Client")
                        || proto.ProtoCategory.Equals("GatewayServer2Client")
                        ))
                    {
        ...
        private void frmMSG_Load(object sender, EventArgs e)
        {
            ...
            lst.Add(new KeyValuePair<string, string>("Client2GatewayServer", "客户端->网关服务器"));
            lst.Add(new KeyValuePair<string, string>("GatewayServer2Client", "网关服务器->客户端"));

            lst.Add(new KeyValuePair<string, string>("Client2WorldServer", "客户端->中心服务器"));
            lst.Add(new KeyValuePair<string, string>("WorldServer2Client", "中心服务器->客户端"));
            lst.Add(new KeyValuePair<string, string>("Client2GameServer", "客户端->游戏服务器"));
            lst.Add(new KeyValuePair<string, string>("GameServer2Client", "游戏服务器->客户端"));

            lst.Add(new KeyValuePair<string, string>("GameServer2WorldServer", "游戏服务器>中心服务器"));
            lst.Add(new KeyValuePair<string, string>("WorldServer2GameServer", "中心服务器->游戏服务器"));

            lst.Add(new KeyValuePair<string, string>("GatewayServer2WorldServer", "网关服务器>中心服务器"));
            lst.Add(new KeyValuePair<string, string>("WorldServer2GatewayServer", "中心服务器->网关服务器"));

            lst.Add(new KeyValuePair<string, string>("GatewayServer2GameServer", "网关服务器>游戏服务器"));
            lst.Add(new KeyValuePair<string, string>("GameServer2GatewayServer", "游戏服务器->网关服务器"));
