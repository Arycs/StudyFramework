...
public struct DTSys_UIForm : IFlatbufferObject
{
...
#if ENABLE_SPAN_T
  public Span<byte> GetAssetPathChineseBytes() { return __p.__vector_as_span<byte>(16, 1); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetAssetPathEnglishBytes() { return __p.__vector_as_span<byte>(18, 1); }
#else
  ...
  public static Offset<YouYou.DataTable.DTSys_UIForm> CreateDTSys_UIForm(FlatBufferBuilder builder,
      int Id = 0,
    ...
    DTSys_UIForm.AddAssetPathEnglish(builder, AssetPath_EnglishOffset);
    DTSys_UIForm.AddAssetPathChinese(builder, AssetPath_ChineseOffset);
  ...
  public static Offset<YouYou.DataTable.DTSys_UIForm> EndDTSys_UIForm(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTSys_UIForm>(o);
  }
};
