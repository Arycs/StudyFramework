...
public struct DTSkillLevel : IFlatbufferObject
{
  ...
  public static Offset<YouYou.DataTable.DTSkillLevel> CreateDTSkillLevel(FlatBufferBuilder builder,
      int Id = 0,
      int SkillId = 0,
      int Level = 0,
      int HurtValueRate = 0,
    ...
    DTSkillLevel.AddBuffValue(builder, BuffValue);
    DTSkillLevel.AddBuffDuration(builder, BuffDuration);
    DTSkillLevel.AddBuffChance(builder, BuffChance);
    DTSkillLevel.AddSkillCDTime(builder, SkillCDTime);
    DTSkillLevel.AddAStatexiaohao(builder, AStatexiaohao);
    DTSkillLevel.AddAStateTimes(builder, AStateTimes);
    DTSkillLevel.AddAbnormalRatio(builder, AbnormalRatio);
    DTSkillLevel.AddStateTime(builder, StateTime);
    DTSkillLevel.AddSpendMP(builder, SpendMP);
    DTSkillLevel.AddHurtValueRate(builder, HurtValueRate);
  ...
  public static void StartDTSkillLevel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<YouYou.DataTable.DTSkillLevel> EndDTSkillLevel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTSkillLevel>(o);
  }
};
