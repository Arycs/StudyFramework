...
public struct DTSys_SceneDetail : IFlatbufferObject
{
...
#if ENABLE_SPAN_T
  public Span<byte> GetScenePathBytes() { return __p.__vector_as_span<byte>(8, 1); }
#else
  ...
  public static Offset<YouYou.DataTable.DTSys_SceneDetail> CreateDTSys_SceneDetail(FlatBufferBuilder builder,
      int Id = 0,
      int SceneId = 0,
  ...
  public static void StartDTSys_SceneDetail(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<YouYou.DataTable.DTSys_SceneDetail> EndDTSys_SceneDetail(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTSys_SceneDetail>(o);
  }
};
