...
public struct DTMaterials : IFlatbufferObject
{
  ...
  public static Offset<YouYou.DataTable.DTMaterials> CreateDTMaterials(FlatBufferBuilder builder,
      int Id = 0,
  ...
  public static Offset<YouYou.DataTable.DTMaterials> EndDTMaterials(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTMaterials>(o);
  }
};
