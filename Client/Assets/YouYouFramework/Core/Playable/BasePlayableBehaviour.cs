...
namespace YouYou
{
    ...
    public abstract class BasePlayableBehaviour<TP> : PlayableBehaviour where TP : IPlayableBehaviourArgs
    {
        /// <summary>
        /// 当前逻辑的参数
        /// </summary>
        ...
        /// 缓存的bool变量, 会在时间轴运行到该clip时, 根据hasToPause值赋值
        /// </summary>
        ...
        public override void OnPlayableDestroy(Playable playable)
        {
            ...
            if (Application.isPlaying)
            {
                ...
                {
                    GameEntry.Pool.EnqueueClassObject(CurrArgs);
                }
            }
        }
