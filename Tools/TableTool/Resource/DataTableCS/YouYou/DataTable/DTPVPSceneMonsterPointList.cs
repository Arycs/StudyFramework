...
public struct DTPVPSceneMonsterPointList : IFlatbufferObject
{
  ...
  public YouYou.DataTable.DTPVPSceneMonsterPoint? DTPVPSceneMonsterPoints(int j) { int o = __p.__offset(4); return o != 0 ? (YouYou.DataTable.DTPVPSceneMonsterPoint?)(new YouYou.DataTable.DTPVPSceneMonsterPoint()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int DTPVPSceneMonsterPointsLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<YouYou.DataTable.DTPVPSceneMonsterPointList> CreateDTPVPSceneMonsterPointList(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateDTPVPSceneMonsterPointsVector(FlatBufferBuilder builder, Offset<YouYou.DataTable.DTPVPSceneMonsterPoint>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateDTPVPSceneMonsterPointsVectorBlock(FlatBufferBuilder builder, Offset<YouYou.DataTable.DTPVPSceneMonsterPoint>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  ...
  public static Offset<YouYou.DataTable.DTPVPSceneMonsterPointList> EndDTPVPSceneMonsterPointList(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<YouYou.DataTable.DTPVPSceneMonsterPointList>(o);
  }
};
