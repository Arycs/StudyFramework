...
/// 服务器返回角色离开场景线消息
/// </summary>
public class GS2C_ReturnRoleLeaveSceneLineHandler
{
    public static void OnHandler(byte[] buffer)
    {
        GS2C_ReturnRoleLeaveSceneLine proto = GS2C_ReturnRoleLeaveSceneLine.Parser.ParseFrom(buffer);
...
#endif
        GameEntry.Data.RoleDataManager.OnReturnRoleLeaveSceneLine(proto);
    }
}